    ...
    async with _get_vision_semaphore():
        try:
            ...
            system_prompt = (
                ...
                f"4) Запрет вымышленных дефектов: не утверждай патологию, ступени или нарушения краевой адаптации, если граница перехода четко не дифференцируется. Отсутствие идеального ракурса или света — не повод придумывать дефекты. «Дефектов не дифференцируется» или «граница вне зоны обзора» — полноценный профессиональный ответ. "
