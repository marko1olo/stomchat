    ...
    async with _get_vision_semaphore():
        try:
            ...
            system_prompt = (
                ...
                f"6) КЛИНИЧЕСКИЙ ЗДРАВЫЙ СМЫСЛ: На терапевтических реставрациях в коффердаме КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО выдумывать хирургические термины («лоскут», «надкостница»). Если на фото изолированное лечение окклюзионной полости (I класс, фиссуры), ЗАПРЕЩЕНО придумывать дефекты контактного пункта, ступеньки или нависающие края к соседним зубам, если апроксимальная стенка не восстанавливалась. "
            ...
            # Gemini на голову превосходит сторонние LPU в распознавании клинических снимков
            # и не галлюцинирует хирургическими терминами на пломбах. Всегда начинаем со
            # старшей модели Gemini, а Groq используем как надежный аварийный резерв.
            start_idx = 0
