...
PASSIVE_COOLDOWN_BASE_MINUTES = 75
PASSIVE_COOLDOWN_MIN_MINUTES = 45
PASSIVE_COOLDOWN_MAX_MINUTES = 180
PASSIVE_VOLUME_GATE_MSGS = 20
DIALOGUE_THREAD_DEBOUNCE_SECONDS = 35
GROQ_WHISPER_MODEL = get_env("GROQ_WHISPER_MODEL", "whisper-large-v3-turbo")
