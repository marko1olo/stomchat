...
MAX_DIALOGUE_BOT_REPLIES = 0
ENABLE_PM_PROACTIVE_PINGS = False
PASSIVE_COOLDOWN_BASE_MINUTES = 0
PASSIVE_COOLDOWN_MIN_MINUTES = 0
PASSIVE_COOLDOWN_MAX_MINUTES = 0
PASSIVE_VOLUME_GATE_MSGS = 0
DIALOGUE_THREAD_DEBOUNCE_SECONDS = 0
GROQ_WHISPER_MODEL = ""
WHISPER_PROMPT = ""
ENABLE_AUDIO_VOLUMEDETECT = False
