...
# «надоел» отдельным словом сюда больше не входит осознанно: оно совпадало с
# «эта работа надоела», и врача, пожаловавшегося на работу, навсегда лишало
# личных сообщений бота. Требуется адресат — «ты надоел», «бот надоел».
# Подробнее и с замером по архиву — в test_silence_policy.py.
for phrase in ["не пиши мне", "отвали", "хватит спамить", "заткнись",
               "ты надоел", "бот надоел"]:
...
for phrase in ["какой протокол ирригации?", "спасибо, помогло", "а что по циркону",
               "эта работа надоела", "надо удалить 36 зуб", "коронка отваливается"]:
