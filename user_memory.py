...
"""
        ...
        response, error = await generate_gemini_text_async(prompt, status_ctx, timeout=30)
...
"""
            ...
            status_ctx = {"kind": "llama_triage", "thinking_level": "LOW"}
            response, error = await generate_gemini_text_async(prompt, status_ctx, timeout=25)
