...
CLINICAL_SOS_CARDS = {   'file': {   'title': '💔 Файлолом (Сломан инструмент в канале)',
    ...
    'anesthesia_failure': {   'title': '⚡️ «Горячий пульпит» — не берет анестезия',
                              ...
                              'crosslinks': [   ('calc', 'calc:articaine', '🧮 Дозы анестетика'),
                                                ('rx', 'rx:cardio', '💊 Кардиориски и адреналин')]},
    'emphysema': {   'title': '💨 Подкожная эмфизема лица и шеи',
                     ...
                     'crosslinks': [   ('record', 'record:surgery', '📝 Хирургия в 043/у'),
                                       ('rx', 'rx:asthma_allergy', '💊 Антибиотики & Аллергия')]},
    'sinus_perf': {   'title': '🦴 Перфорация гайморовой пазухи (Ороантральное соустье)',
                      ...
                      'crosslinks': [   ('record', 'record:surgery', '📝 Протокол 043/у пазухи'),
                                        ('concilium', 'concilium:ortho_implant', '🏛 Синус-лифтинг & Имплант')]},
    ...
    'dislocation': {   'title': '💥 Острый вывих нижней челюсти в кресле',
                       ...
                       'crosslinks': [   ('record', 'record:complication', '📝 Протокол вывиха 043/у'),
                                         ('concilium', 'concilium:example', '🏛 Окклюзия & ВНЧС')]}}
...
CLINICAL_RECORD_TEMPLATES = {   'therapy': {   'title': '🦷 Кариес дентина (Терапия)',
                   'text': '📋 <b>Шаблон 043/у: Терапевтический приём (Глубокий кариес)</b>\n'
                           ...
                           'месяцев.',
                   'crosslinks': [   ('rx', 'rx:cardio', '💊 Соматика (Анестетик)'),
                                     ('vs', 'vs:adhesion', '⚖️ Бонд FL vs Universal'),
                                     ('sos', 'sos:anesthesia_failure', '🚨 Если не берет анестезия')]},
    ...
    'surgery': {   'title': '🔪 Удаление ретинированного 3.8 (Хирургия)',
                   'text': '📋 <b>Шаблон 043/у: Хирургический приём (Атипичное удаление ретинированного 3.8)</b>\n'
                           ...
                           'дней.',
                   'crosslinks': [   ('sos', 'sos:bleed', '🚨 Упорное кровотечение'),
                                     ('rx', 'rx:anticoag', '💊 Пациент на антикоагулянтах'),
    ...
    'perio': {   'title': '🩸 SRP Пародонтология (Кюретаж)',
                 ...
                 'crosslinks': [   ('vs', 'vs:airflow', '⚖️ Порошки: Глицин vs Сода'),
                                   ('rx', 'rx:diabetes', '💊 Сахарный диабет и пародонт'),
                                   ('trans', 'trans:bone', '🗣 «Кость во рту рассосалась»')]},
    'endo': {   'title': '🔬 Первичная эндодонтия MB2 (Эндо)',
                'text': '📋 <b>Шаблон 043/у: Эндодонтическое лечение (Пульпит с анатомией MB2)</b>\n'
                        ...
                        'под коронку.',
                'crosslinks': [   ('vs', 'vs:sealer', '⚖️ Биокерамика vs AH Plus'),
                                  ('sos', 'sos:file', '🚨 Если сломался файл'),
                                  ('vs', 'vs:post', '⚖️ Феррул и выбор штифта')]},
    'implant': {   'title': '🔩 Дентальная имплантация (Имплант)',
                   'text': '📋 <b>Шаблон 043/у: Хирургический приём (Дентальная имплантация 3.6)</b>\n'
                           ...
                           'ФДМ) через 3 месяца.',
                   'crosslinks': [   ('sos', 'sos:torque_loss', '🚨 Если сорван торк (<15 Нсм)'),
                                     ('vs', 'vs:implant_retention', '⚖️ Винтовая vs Цементная фиксация'),
                                     ('rx', 'rx:mronj', '💊 Бисфосфонаты и имплантация')]},
    'pediatric': {   'title': '🧸 Пульпотомия молочного зуба (Детство)',
                     ...
                     'crosslinks': [   ('trans', 'trans:milk_teeth', '🗣 «Зачем лечить молочные»'),
                                       ('vs', 'vs:gi_composite', '⚖️ СИЦ vs Композит у детей'),
                                       ('vs', 'vs:mta', '⚖️ Biodentine vs MTA')]},
    'complication': {   'title': '⚠️ Оформление осложнения (Юр. защита)',
                        ...
                        'crosslinks': [   ('sos', 'sos:file', '🚨 SOS: Файлолом у кресла'),
                                          ('sos', 'sos:perf', '🚨 SOS: Перфорация дна/стенки'),
                                          ('trans', 'trans:script', '🗣 Скрипт разговора без чувства вины')]}}
...
RX_RISK_CARDS = {   'mronj': {   'title': '🦴 Бисфосфонаты и остеонекроз (MRONJ)',
                 ...
                 'crosslinks': [   ('record', 'record:surgery', '📝 Шаблон 043/у удаления'),
                                   ...
                                   ('sos', 'sos:bleed', '🚨 SOS при кровотечении')]},
    'anticoag': {   'title': '🩸 Антикоагулянты и антиагреганты',
                    ...
                    'crosslinks': [   ('sos', 'sos:bleed', '🚨 SOS: Упорное кровотечение'),
                                      ('record', 'record:surgery', '📝 Шаблон 043/у удаления'),
                                      ('rx', 'rx:cardio', '💊 Кардиологический статус')]},
    ...
    'endo': {   'title': '🛡 Профилактика инфекционного эндокардита',
                ...
                'crosslinks': [   ('record', 'record:perio', '📝 Пародонтология SRP'),
                                  ('record', 'record:implant', '📝 Имплантация 043/у'),
                                  ('rx', 'rx:asthma_allergy', '💊 Аллергия на пенициллин')]},
    'pregnancy': {   'title': '🤰 Беременность и лактация',
                     ...
                     'crosslinks': [   ('calc', 'calc:articaine', '🧮 Расчет Артикаина 1:200к'),
                                       ('trans', 'trans:calcium', '🗣 «Ребенок кальций высосал»'),
    ...
    'diabetes': {   'title': '🩸 Сахарный диабет I и II типа',
                    ...
                    'crosslinks': [   ('record', 'record:perio', '📝 Протокол SRP в 043/у'),
                                      ('record', 'record:implant', '📝 Имплантация и остеоинтеграция'),
                                      ('sos', 'sos:anesthesia_failure', '🚨 Анестезия при диабете')]},
    'asthma_allergy': {   'title': '🫁 Бронхиальная астма и поливалентная аллергия',
                          ...
                          'crosslinks': [   ('calc', 'calc:mepivacaine', '🧮 Мепивакаин 3% расчет'),
                                            ('trans', 'trans:adrenalin_allergy', '🗣 «Аллергия на адреналин»'),
                                            ('vs', 'vs:isolation', '⚖️ Безлатексная изоляция')]},
    'renal_liver': {   'title': '🧪 Почечная и печеночная недостаточность',
                       ...
                       'crosslinks': [   ('calc', 'calc:articaine', '🧮 Безопасность Артикаина'),
                                         ('sos', 'sos:bleed', '🚨 SOS при кровотечении'),
                                         ('rx', 'rx:anticoag', '💊 Коагулопатия и гемостаз')]}}
...
CONCILIUM_CARDS = {   'example': {   'title': '🏛 Тотальная реабилитация при стираемости',
                   ...
                   'crosslinks': [   ('record', 'record:ortho', '📝 Шаблон 043/у ортопедии'),
                                     ('vs', 'vs:bopt', '⚖️ BOPT vs Chamfer'),
                                     ('rx', 'rx:cardio', '💊 Кардиоскрининг перед операцией')]},
    'endo_perio': {   'title': '🔬 Сочетанное эндо-пародонтальное поражение',
                      ...
                      'crosslinks': [   ('record', 'record:perio', '📝 Шаблон 043/у SRP'),
