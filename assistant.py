...
def build_main_menu_markup():
    ...
    return [
        ...
        [Button.inline("🏛 Консилиум", data="nav:concilium"),      Button.inline("📚 Клинические протоколы", data="nav:proto")],
        [Button.inline("🔍 Найти статью / протокол", data="nav:web"), Button.inline("🎲 Клинический квиз", data="nav:quiz")],
        [Button.inline("🎮 Симулятор кейса", data="nav:case"),    Button.inline("👤 Мой профиль", data="nav:profile")],
        [Button.inline("⭐ Мои закладки", data="nav:bookmarks"), Button.inline("💬 Клинический вопрос", data="nav:chat")],
