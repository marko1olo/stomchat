...
async def process_weekly_batch(messages, client, chat_id, topic_id=None, delivery_hook=None):
    ...
    *   **Ортодонтия:** (Брекеты, элайнеры...)
    ...
    ЛОГ НЕДЕЛИ:
    {full_text}
    Инструкция для самопроверки: Напиши максимально подробную, профессиональную, глубокую и развернутую статью в пределах 20000–35000 символов. Излагай клиническую логику, протоколы, цифры и бренды во всех подробностях, не сокращай детали ради экономии места.
    """
